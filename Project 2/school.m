...
load('schoolTable.mat');
negativeStop = imageDatastore({'stop\*.jpg','other\*.jpg'});
...
for rr = 1:r
    ...
    for ff = 1:size(fAlarm,2)
        parfor cc = 1:size(cascades,2)
            xmlFile = char(strcat("school",num2str(rr),"_",num2str(fAlarm(ff)),"_",num2str(cascades(cc)),".xml"));
...
save('school1.mat','b0','b1','bg1','stopSign');
% 
% 
...
%     
% end
% save('school2.mat','cn0','cn1','cng1','cnstopSign');
% 
% 
...
%                     tng11 = tng11 + 1;
%                 end
%                 fprintf("3 school class test rand=%d\tcascade=%d\tfalse rate=%d\t tt=%d\n",rr,cascades(cc),fAlarm(ff),tt);
%             end
%             tn000(ff,cc) = tn00;
%             tn111(ff,cc) = tn11;
%             tng111(ff,cc) = tng11;
...
%             fprintf("3 school class test rand=%d\tcascade=%d\tfalse rate=%d\n",rr,cascades(cc),fAlarm(ff));
%         end
%         
%     end
%         tn0{rr} = tn000;
...
%     
% end
% save('school3.mat','tn0','tn1','tng1','tnstopSign');
% 
% 
...
%     
% end
% save('school4.mat','n0','n1','ng1','nstopSign');
% 
% 
% %%
% clear
